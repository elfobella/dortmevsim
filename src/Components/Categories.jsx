...
import Ticari from "../assets/ticari-car.jpg";
...
const Categories = () => {
  const categories = [
    ...
    {
      title: "Ticari Araç Aküleri",
      description: "Ticari araçlar için dayanıklı çözümler.",
      image: Ticari,
    },
    {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((category, index) => (
            <motion.div
              ...
              className="relative bg-white group rounded-lg overflow-hidden transition-shadow duration-300"
            >
              {/* Görsel Arka Plan */}
              <img
                src={category.image}
